  ...
  return (
    ...
    >
      <div className="flex h-full min-h-0 flex-col">
        <header className="flex shrink-0 items-center justify-between gap-4 border-b border-slate-200 bg-white px-4 py-3 sm:px-5 sm:py-4">
          ...
          <button type="button" onClick={onClose} aria-label="Close assistant" className="grid size-11 shrink-0 place-items-center rounded-md text-2xl text-slate-600 transition hover:bg-slate-100 hover:text-slate-900">×</button>
        </header>
